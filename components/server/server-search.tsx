  ...
  return (
    <>
      <button
       ...
       hover:bg-zinc-700/10 dark:hover:bg-zinc700/50 transition"
      >
        <Search className="w-4 h-4 tet-zinc-500 dark:text-zinc-400" />
        <p
          className="font-semibold text-sm text-zinc-500 dark:text-sinc-400
